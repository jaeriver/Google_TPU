...
flags.DEFINE_string(
    ...
    ('The directory where the model weights and training/evaluation summaries '
     'are stored. If not specified, save to /tmp/mobilenet.'))

# Special flags for MobileNet.
flags.DEFINE_bool(
...
NUM_CLASSES = 1000
IMAGE_SIZE = 224
EPOCHS = 5  # Standard imagenet training regime.
...
DEFAULT_MODEL_DIR = '/tmp/mobilenet'
WEIGHTS_TXT = 'mobilenet_weights.h5'
...
def sparse_top_k_categorical_accuracy(y_true, y_pred, k=5):
  ...
  return tf.math.in_top_k(y_true, y_pred, k)
